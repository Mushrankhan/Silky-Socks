...
class SweetAlert: UIViewController {
    ...
    var animatedView: protocol<AnimatableView>?
    ...
    func resizeAndRelayout() {
        ...
        if animatedView != nil {
            ...
            contentView.addSubview((animatedView! as! UIView))
    ...
    func cleanUpAlert() {
        ...
        if self.animatedView != nil {
            (self.animatedView! as! UIView).removeFromSuperview()
...
class CancelAnimatedView: UIView, AnimatableView {
...
class InfoAnimatedView: UIView, AnimatableView {
...
class SuccessAnimatedView: UIView, AnimatableView {
