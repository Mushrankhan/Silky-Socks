...
class Template: NSObject {
    ...
    class func allTemplates() -> [Template] {
        ...
        let kneeHigh = Template(image: Img(named: "kneehigh")!, type: .Socks, maskImage: Img(named: "kneehigh_noblack"), infoCaption: "Knee-high Compression Socks", info: "This style has a Solid Cotton foot for ultimate comfort + Polyester, Rubber and Spandex Blend.  The Leg holds the print and goes all the way up the leg, just below the kneecap. The foot carries extra padding and CUSHION for increased support along with thick ribbing for a secure, tight fit. Quality Guaranteed!", infoImage: Img(named: "KneeHighProduct")!, price: [20, 16, 14], productId: "1371709761", productSize: CGSize(width: 11 * calculations, height: 15 * calculations), index: 2)

        let white_tee = Template(image: Img(named: "white_tee")!, type: .Shirt, maskImage: Img(named: "white_tee_noneck"), infoCaption: "T-shirt", info: "This is a full front dye sublimation print on a premium American Apparel 4.5 oz. 100% polyester moisture management t-shirt.  A trusted fashion fit t-shirt with ribbed collar, Double-needle hem sleeves and bottom for a great fit.", infoImage: Img(named: "WhiteTeeProduct")!, price: [28, 20, 14], productId: "1371733057", productSize: CGSize(width: 20.65 * calculations, height: 16.3 * calculations), index: 3)

        let tank = Template(image: Img(named: "tank")!, type: .Tank, maskImage: Img(named: "tank_cut"), infoCaption: "Tank Top", info: "An American Apparel high quality tank with full front Sublimation print.  Perfect for making one-of-a-kind designs with an ultra-soft-to-the-touch feel.  100% Polyester Jersey construction, fashion fitted.  The back side will be white.", infoImage: Img(named: "TankProduct")!, price: [28, 23, 19], productId: "1371751809", productSize: CGSize(width: 12.2 * calculations, height: 18.3 * calculations), index: 4)
        
        let black_tee = Template(image: Img(named: "black_sleeve")!, type: .Shirt, maskImage: Img(named: "black_sleeve_nocollar"), infoCaption: "Blackout T-shirt", info: "This shirt has is a black sleeves, black collar, and black back with a front body dye sublimation print.  A premium 4.5 oz. 100% polyester moisture management t-shirt with a fashion fit, ribbed collar, double-needle hem sleeves and bottom for a great fit.", infoImage: Img(named: "BlackTeeProduct")!, price: [29, 24, 20], productId: "1371773057", productSize: CGSize(width: 11.5 * inch / scale, height: 15.5 * inch / scale), index: 5)
