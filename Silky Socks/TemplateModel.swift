...
class Template: NSObject {
    ...
    init(image: UIImage, type: TemplateType, maskImage: UIImage?, infoCaption: String, info: String, infoImage: UIImage?, price: [NSDecimalNumber], productId: String, productSizes: [CGSize], index: Int) {
