...
class Template: NSObject {
    ...
    class func allTemplates() -> [Template] {
        ...
        let white_tee = Template(image: Img(named: "white_tee")!, type: .Shirt, maskImage: nil, infoCaption: "T-shirt", info: "This is a full front dye sublimation print on a premium 4.5 oz. 100% polyester moisture management t-shirt. A fashion fit t-shirt with a ribbed collar with a Double-needle hem sleeves and bottom for a great fit.", infoImage: Img(named: "WhiteTeeProduct")!, price: [28, 20, 14], productId: "1371733057", productSize: CGSize(width: 20.65 * calculations, height: 16.3 * calculations), index: 3)

        let tank = Template(image: Img(named: "tank")!, type: .Tank, maskImage: nil, infoCaption: "Tank Top", info: "An American Apparel high quality tank with full front Sublimation print. Perfect for making one-of-a-kind designs with an ultra-soft-to-the-touch feel. 100% Polyester Jersey construction, Fashion fitted.  Back side will be white.", infoImage: Img(named: "TankProduct")!, price: [28, 23, 19], productId: "1371751809", productSize: CGSize(width: 12.2 * calculations, height: 18.3 * calculations), index: 4)
