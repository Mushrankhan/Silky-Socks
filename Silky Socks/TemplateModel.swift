...
//        }
        ...
        let black_tee = Template(image: Img(named: "black_sleeve")!, type: .Shirt, maskImage: Img(named: "black_sleeve_nocollar"), infoCaption: "Blackout T-shirt", info: "This shirt has black sleeves, black collar, and black back with a front body dye sublimation print.  A premium 4.5 oz. 100% polyester moisture management t-shirt with a fashion fit, ribbed collar, double-needle hem sleeves and bottom for a great fit.", infoImage: Img(named: "BlackTeeProduct")!, price: [26, 24, 20], productId: "1371773057", productSize: CGSize(width: 11.5 * inch / scale, height: 15.5 * inch / scale), index: 5, availabilitySizes: ["S", "M", "L", "XL", "XXL"])
