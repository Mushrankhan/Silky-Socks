...
class Template: NSObject, Printable {
    ...
    class func allTemplates() -> [Template] {
        ...
        //let white_tee_sizes = [CGSize(width: 36 * calculations, height: 32 * calculations), CGSize(width: 39 * calculations, height: 33 * calculations), CGSize(width: 42 * calculations, height: 34 * calculations), CGSize(width: * calculations, height: * calculations), CGSize(width: 46 * calculations, height: 36 * calculations), CGSize(width: 47 * calculations, height: 37 * calculations)]
