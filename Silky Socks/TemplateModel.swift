...
class Template: NSObject {
    ...
    class func allTemplates() -> [Template] {
        ...
        let tank = Template(image: Img(named: "tank")!, type: .Tank, maskImage: Img(named: "tank_nocollar"), infoCaption: "Tank Top", info: "An American Apparel high quality tank with full front Sublimation print. Perfect for making one-of-a-kind designs with an ultra-soft-to-the-touch feel. 100% Polyester Jersey construction, Fashion fitted.  Back side will be white.", infoImage: Img(named: "TankProduct")!, price: [28, 23, 19], productId: "1371751809", productSize: CGSize(width: 12.2 * calculations, height: 18.3 * calculations), index: 4)
