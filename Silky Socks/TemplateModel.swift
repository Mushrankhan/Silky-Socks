...
class Template {
    ...
    class func allTemplates() -> [Template] {
        return [Template(image: UIImage(named: "blank")!,caption: "", type: .Socks),
                Template(image: UIImage(named: "blackfoot")!,caption: "Black Foot", type: .Socks),
                Template(image: UIImage(named: "kneehigh")!,caption: "Knee High Black Foot", type: .Socks),
                Template(image: UIImage(named: "white_tee")!,caption: "White Tee", type: .Shirt),
                Template(image: UIImage(named: "tank")!,caption: "Tank", type: .Tank),
